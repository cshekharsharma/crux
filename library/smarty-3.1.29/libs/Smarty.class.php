...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplateDir('.' . DS . 'data' . DS . 'templates' . DS)
        ->setCompileDir('.' . DS . 'data' . DS . 'cache' . DS . 'templates_c' . DS)
        ->setPluginsDir(SMARTY_PLUGINS_DIR)
        ->setCacheDir('.' . DS . 'data' . DS . 'cache' . DS)
        ->setConfigDir('.' . DS . 'data' . DS . 'configs' . DS);
